...
add_filter('adi_git_config_location', 'eight_sec_git_url_config' );
function eight_sec_git_url_config(){
	$git_url = 'https://raw.githubusercontent.com/8degreethemes/8degreethemes.github.io/master/demos/eight-sec/config.json';
	return $git_url;
}