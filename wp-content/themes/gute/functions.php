...
function gute_scripts() {
	...
	wp_enqueue_style( 'gute-default', get_template_directory_uri().'/assets/css/default.css',array(),'1.1.2','all' );
	wp_enqueue_style( 'gute-style', get_stylesheet_uri(),array(),'1.1.2','all' );
