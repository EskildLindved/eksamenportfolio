...
function selfer_theme_ocdi_import_files() {
    return array(
        array(
            ...
            'import_file_url'            =>     esc_url('http://demo.softhopper.net/selfer-demo/demo-content.xml'),
            'import_widget_file_url'     =>     esc_url('http://demo.softhopper.net/selfer-demo/widgets.wie'),
            'import_customizer_file_url' =>     esc_url('http://demo.softhopper.net/selfer-demo/selfer-export.dat'),
            'import_preview_image_url'   =>     esc_url('http://demo.softhopper.net/selfer-demo/screenshot.png'),
            'import_notice'              =>     esc_html__( 'Before importing demo data you must have to install required plugins', 'selfer' ),
            'preview_url'                =>     esc_url('http://demo.softhopper.net/selfer/'),
        ),
    );
}
